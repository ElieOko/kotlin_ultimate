package com.example.custom.view.Widget.Country.component
...
import com.example.custom.view.Widget.Country.data.utils.*
import com.example.custom.view.Widget.Country.transformation.PhoneNumberTransformation
...
fun TogiCountryCodePicker(
    ...
    Surface(color = color) {
        Column(modifier = Modifier.padding(horizontal = 1.dp, vertical = 1.dp)) {
            if (bottomStyle) {
                TogiCodeDialog(modifier = Modifier.width(22.dp),
                    pickedCountry = {
